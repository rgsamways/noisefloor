// A tiny seeded PRNG (mulberry32) — deterministic, dependency-free. All we
// need is "same seed in, same sequence out"; no cryptographic or
// distribution requirements apply to synthetic chart data.
